var rG, oG, yG, gG, bG,  score, redimg, bomb, bombimg, lsound, wsound, bsound, orangeimg, yellowimg, greenimg, playerimg, player, blueimg, binimg, cannonimg, ground, gameState; 
var red =[];
var orange = [];
var yellow = [];
var green = [];
